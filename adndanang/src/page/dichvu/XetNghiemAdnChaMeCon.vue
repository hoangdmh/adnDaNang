<template>
	<div class="content-sub">
        <div class="inner">
            ...
            <p><span class="col-blue">KẾT LUẬN XÉT NGHIỆM ADN</span></p>
        ...
        <div class="inner">
            <p><span class="col-blue">NHỮNG MẪU CÓ THỂ SỬ DỤNG ĐỂ<a href="http://adndanang.com">XÉT NGHIỆM</a> ADN</span></p>
            <p>Những mẫu thông dụng được lựa chọn đó là máu, móng tay (chân), tế bào niêm mạc miệng, góc tóc… những mẫu thử này có thể tiện lợi cho người thử nếu muốn giữ bí mật,… Hoặc bạn có thể lựa chọn những mẫu thử đặc biệt như bàn chải đánh răng, tinh trùng, bả kẹo cao su, nước mũi, đầu lọc thuốc lá, bao cao su …là những vật dụng mà cá nhân đã từng tiếp xúc với cơ thể của họ.</p>
            <p><b>Chú ý: Tất cả các mẫu xét nghiệm chỉ cho ra một kết quả giống nhau nên bạn có thể lựa chọn mẫu xét nghiệm phù hợp nhất cho mình để thực hiện dịch vụ xét nghiệm.</b></p>
        </div>
    </div>
</template>
